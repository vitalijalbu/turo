...
const Signup = (f7router) => {
  ...
  return (
    <Page loginScreen>
        <Block>
          <Button large iconF7="logo_google" outline className='google_btn'>Continua con Google</Button>
  </Block>    
  <Block>
          <Button large iconF7="logo_facebook" outline className='fb_btn'>Continua con Facebook</Button>
  </Block>
