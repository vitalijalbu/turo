        ...
        <Row>
          ...
          <table class="table">
                    ...
                    <th scope="row">
                      <div class="d-flex align-items-center">
                        ...
                        <div className="avatar avatar-xl mb-2">
                              <img src={entry.media_photos[0]?.url ?? '/img/placeholder.svg'} className="avatar-img rounded-circle border border-2 border-white"/>
                        </div>
                        </div>
                        <div class="ms-2">
                          <h5 class="mb-1">
                ...
                <UncontrolledDropdown>
                  ...
                  <DropdownMenu>
                    <DropdownItem><Link href={`/account/hosting/${entry.id}`}>Modifica</Link></DropdownItem>
                    <DropdownItem onClick={handleArchive}>Archivia</DropdownItem>
                    <DropdownItem divider />
                    <DropdownItem onClick={handleDelete} className="text-danger">Elimina</DropdownItem>
                  </DropdownMenu>
                </UncontrolledDropdown>
              </div>
                      </td>
