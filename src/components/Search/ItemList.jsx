...
const ItemList = ({ data }) => {
  ...
  return (
    <li>
      ...
      {data.badge && <Chip color="primary" text={data.badge} className="item-ribbon"/>}
        {/**/}
          ...
          <div className="item-row display-flex justify-content-space-between align-items-center">
            ...
            <div className="">
              <div className="item-actions">
                <Button raised small iconF7="heart" className="rounded" onClick={addToFavorite}></Button>
                <Button raised small iconF7="square_arrow_up" className="rounded" onClick={addToFavorite}></Button>
              </div>
            </div>
          </div>
